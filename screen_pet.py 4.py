...
pupil_left = c.create_oval(140,145,150,155, outline='black',fil='white')
...
smooth=1, width=2, state=HIDDEN)
cheek_left = c.create_oval(70,180,120,230, outline='red',
fill='pink', state=HIDDEN)
cheek_right = c.create_oval(280,180,330,230,outline='red',
fill='pink', state=HIDDEN)
...
def show_happy(event):
    if (20 <= event.x <= 350) and (20 <= event.y <= 350):
        ...
        c.itemconfigure(mouth_sad, statre=HIDDEN)
        return
    def hide_happy(event):
        c.itenconfigure(cheek_left, state=HIDDEN)
